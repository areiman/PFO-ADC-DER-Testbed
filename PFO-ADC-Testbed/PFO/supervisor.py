...
# os.system('julia PFO/PFO_flex.jl PFO/data/case24_ieee_rts.m testbed/data/case24_flex.csv')
#os.system('julia PFO/PFO_flex.jl testbed/data/123_flex.csv')
os.system('julia PFO_flex.jl data/ieee123_flex.csv') # path to flexibility file
os.system('echo --- Julia Finished ---')

# read output file(s) written by Julia
print('reading PFO_output.csv')
