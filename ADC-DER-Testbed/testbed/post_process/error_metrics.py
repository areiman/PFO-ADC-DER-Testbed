...
def calculate(adc_agg, adc_Prating, cosim_data):
    ...
    for adc_num in adc_agg:
        ...
        if "battInv" in adc_agg[adc_num]:
            ...
            temp_err = abs(cosim_data[adc_num]['batt_p'][0:2] - np.real(adc_agg[adc_num]['battInv'])[3:6:2])
        ...
        if "solarInv" in adc_agg[adc_num]:
            ...
            temp_err = abs(cosim_data[adc_num]['pv_p'][0:2] - np.real(adc_agg[adc_num]['solarInv'])[3:6:2])
        ...
        if "hvac" in adc_agg[adc_num]:
            ...
            temp_err = abs(cosim_data[adc_num]['ac_p'][0:2] - np.real(adc_agg[adc_num]['hvac'])[3:6:2])
        ...
        if "wh" in adc_agg[adc_num]:
            ...
            temp_err = abs(cosim_data[adc_num]['ewh_p'][0:2] - np.real(adc_agg[adc_num]['wh'])[3:6:2])
