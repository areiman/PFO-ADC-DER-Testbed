...
cd ~/PFO-ADC-DER-Testbed/ADC-DER-Testbed/ADCDER_Dummy/Python/ && export FNCS_LOG_STDOUT=yes && export FNCS_LOG_LEVEL=DEBUG4 && export FNCS_BROKER=tcp://localhost:5570 && FNCS_CONFIG_FILE=fncs_Mar7.zpl && exec python3.6 FNCS_API.py 3 FNCS_API.txt &> FNCS_API.out &
